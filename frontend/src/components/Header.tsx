    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-sm">
      <div className="max-w-7xl mx-auto px-2.5 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3 shrink-0">
          ...
          <div className="bg-sky-600 text-white p-2 rounded-lg flex items-center justify-center font-bold shrink-0 transition-transform duration-300 hover:rotate-6 hover:scale-105 shadow-xs">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4 shrink-0">
          ...
          {isSuperAdmin ? (
            <span className="inline-flex items-center px-2 sm:px-3 py-1 rounded-full text-[10px] sm:text-xs font-black bg-amber-100 text-amber-900 border border-amber-300 shadow-xs shimmer-badge transition-all duration-300 hover:scale-105">
              <Crown className="w-3 h-3 sm:w-3.5 sm:h-3.5 mr-1 text-amber-600 shrink-0 animate-bounce" />
              <span className="hidden sm:inline">SUPER ADMIN PORTAL</span>
              <span className="inline sm:hidden uppercase font-black">SUPER</span>
            </span>
          ) : (
            <span className={`inline-flex items-center px-2 sm:px-2.5 py-1 rounded-full text-[10px] sm:text-xs font-medium border transition-all duration-200 hover:scale-105 ${
              role === 'ADMIN' 
          ...
          <button
            ...
            className="inline-flex items-center space-x-1 px-2.5 sm:px-3 py-1.5 text-xs font-semibold text-rose-600 hover:bg-rose-50 border border-rose-200 rounded-lg transition-all duration-200 hover:scale-105 active:scale-95 shadow-2xs"
          >
